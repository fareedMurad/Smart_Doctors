        ...
        <ScrollView >
          <Block style={{ backgroundColor: '#fff' }}>
            <Block flex={false} style={styles.header} margin={[30, 0, 0, 0]}>
              <Text h1 bold style>About Diabetes</Text>
            ...
            <TouchableOpacity
              ...
              onPress={() => []}
            >
              <Image source={require('../../assets/images/dibiteas.jpg')} style={[styles.image, styles.mainImage]} />
            </TouchableOpacity>
            <Block style={{ display: 'flex', flexDirection: 'row', padding: 10, marginTop: 10 }}>
              <Image source={require('../../assets/images/diybitie.jpg')} style={{ width: '45%', height: 150, }} />
              <Image source={require('../../assets/images/dibities.jpg')} style={{ width: '45%', height: 150, marginLeft: 20 }} />
              {/* <Image source={require('../../assets/doctors_img/diabetes.jpg')} />
            <Image source={require('../../assets/doctors_img/diabetes.jpg')} /> */}
            </Block>

            <Block>
              <Block padding={[20, 20, 0, 20]}>
                <Text bold h1>History of Diabetes</Text>
